...
- [](https://gy19cp.github.io/------.html) - In-depth Model Guidance PDF document with detail on the software intention, current issues, design, UML Diagrams and future developments.
...
- Version 2 folder - Previous Model version. This is semi-working, with a working animation, however Drunks start at home, this should happen at the end of the model and the excel document is written in.
...
**Step 7 -** Now select the 'model2.py' file within Spyder and click ‘Run’ once more. When the Model pops out it contains a Graphical User Interface with 3 clearly marked Steps A to C. ...... A text box with number of Drunks Home is also present.  
